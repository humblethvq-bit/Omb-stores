...
const PRODUCTS = [
  ...
  // Samsung catalog — models added before the photo-download stage. Prices stay on request until OMB confirms stock/pricing.
  P({ name: "Samsung Galaxy A14", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A14. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A15", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A15. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A16", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A16. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A17 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A17 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A24", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A24. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A25 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A25 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A26 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A26 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A27 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A27 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A34 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A34 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A35 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A35 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A36 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A36 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A37 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A37 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  ...
  P({ name: "Samsung Galaxy A55 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A55 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A56 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A56 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A57 5G", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy A57 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S20", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S20. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S20+", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S20+. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S20 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S20 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S21", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S21. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S21 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S21 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S22", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S22. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S22 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S22 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S23", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S23. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S23 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S23 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S24", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S24. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S24 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S24 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S25", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S25. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S25 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S25 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S26", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S26. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S26+", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S26+. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy S26 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy S26 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Note 20", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Note 20. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Note 20 Ultra", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Note 20 Ultra. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 3", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 3. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 4", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 4. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 5", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 5. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 6", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 6. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 7", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 7. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Flip 8", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Flip 8. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 3", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 3. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 4", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 4. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 5", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 5. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 6", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 6. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 7", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 7. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy Z Fold 8", brand: "Samsung", category: "Smartphones", price: null, description: "Samsung Galaxy Z Fold 8. Price is on request.", specs: ["Catalog model", "Price on request"] }),

  // TECNO catalog — models added before the photo-download stage. Prices stay on request until OMB confirms stock/pricing.
  P({ name: "Tecno Camon 18", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 18. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Camon 19", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 19. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  ...
  P({ name: "Tecno Camon 30", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 30. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Camon 40", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 40. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Camon 50", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 50. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Camon 50 Ultra 5G", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Camon 50 Ultra 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 8", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 8. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 10", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 10. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 20", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 20. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 30", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 30. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 40", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 40. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 50", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 50. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 50 Pro", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 50 Pro. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Spark 50 5G", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Spark 50 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Pova 5", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Pova 5. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Pova 6", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Pova 6. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Pova 7", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Pova 7. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Pova 8 Pro 5G", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Pova 8 Pro 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Phantom X2", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Phantom X2. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Phantom V Flip 5G", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Phantom V Flip 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Tecno Phantom V Fold2 5G", brand: "Tecno", category: "Smartphones", price: null, description: "Tecno Phantom V Fold2 5G. Price is on request.", specs: ["Catalog model", "Price on request"] }),
  P({ name: "Samsung Galaxy A54", brand: "Samsung", category: "Smartphones", price: 3600, featured: true, installment: true, description: "Vibrant AMOLED display, 50MP camera and long battery life for everyday use.", specs: ["128GB storage", "6.4\" Super AMOLED", "50MP triple camera", "5000mAh battery"] }),
  P({ name: "Tecno Camon 20", brand: "Tecno", category: "Smartphones", price: 2450, previousPrice: 2750, featured: true, installment: true, description: "Sharp 64MP camera and smooth performance built for Ghanaian creators.", specs: ["256GB storage", "6.67\" AMOLED", "64MP camera", "5000mAh battery"] }),
